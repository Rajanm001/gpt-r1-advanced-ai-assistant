...
```OPENROUTER_API_KEY=your_openrouter_api_key_herecd frontend[![FastAPI](https://img.shields.io/badge/FastAPI-0.117.0-009688?style=for-the-badge&logo=fastapi)](https://fastapi.tiangolo.com)
...
```## 📁 Project Structure```## 🚀 Quick Start[![Next.js](https://img.shields.io/badge/Next.js-14.0.3-000000?style=for-the-badge&logo=nextdotjs)](https://nextjs.org)
...
# Frontend  │   ├── requirements.txt     # Python dependencies[![TypeScript](https://img.shields.io/badge/TypeScript-5.0-3178C6?style=for-the-badge&logo=typescript)](https://typescriptlang.org)
...
- **Host**: 0.0.0.0 (accepts connections from all interfaces)│       ├── models/         # Data models### Prerequisites[![SQLite](https://img.shields.io/badge/SQLite-Database-003B57?style=for-the-badge&logo=sqlite)](https://sqlite.org)
...
cd frontend│   ├── components/         # React components- Python 3.8+[![OpenAI](https://img.shields.io/badge/OpenAI-GPT4-FF6B35?style=for-the-badge&logo=openai)](https://openai.com)
...
npm run dev[![FastAPI](https://img.shields.io/badge/FastAPI-0.117.0-009688?style=for-the-badge&logo=fastapi)](https://fastapi.tiangolo.com)

### Sample API Response:

```json```[![Next.js](https://img.shields.io/badge/Next.js-14.0.3-000000?style=for-the-badge&logo=nextdotjs)](https://nextjs.org)

{

  "status": "healthy", Frontend runs on: http://localhost:3001[![TypeScript](https://img.shields.io/badge/TypeScript-5.0-3178C6?style=for-the-badge&logo=typescript)](https://typescriptlang.org)

  "message": "OpenRouter ChatGPT Clone is FULLY OPERATIONAL!",

  "api_key_status": "configured and working",[![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen?style=for-the-badge)](https://github.com/Rajanm001/gpt-r1-advanced-ai-assistant)
...
[![⭐ Star this repo](https://img.shields.io/github/stars/Rajanm001/gpt-r1-advanced-ai-assistant?style=social)](https://github.com/Rajanm001/gpt-r1-advanced-ai-assistant/stargazers)
[![🍴 Fork this repo](https://img.shields.io/github/forks/Rajanm001/gpt-r1-advanced-ai-assistant?style=social)](https://github.com/Rajanm001/gpt-r1-advanced-ai-assistant/network/members)
...
graph TB
    ...
    B -->|OpenAI API| D[GPT-4 Models]
    B -->|DuckDuckGo| E[Web Search]
    
    F[Glass Morphism UI] --> A
    G[Real-time Streaming] --> A
    H[Conversation Management] --> A
    
    I[Chat Service] --> B
    J[Database Service] --> B
    K[Search Service] --> B
```
...
[![GitHub stars](https://img.shields.io/github/stars/Rajanm001/gpt-r1-advanced-ai-assistant?style=social)](https://github.com/Rajanm001/gpt-r1-advanced-ai-assistant/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/Rajanm001/gpt-r1-advanced-ai-assistant?style=social)](https://github.com/Rajanm001/gpt-r1-advanced-ai-assistant/network/members)
